(function() {
    ...
    function SectionManager() {
        ...
        self.get = function(id) {
            return storage[id] !== undefined ? storage[id] : true;
        };
    ...
    function renderSettings() {
        ...
        if(order.length) {
            sections.sort(function(a,b){ return order.indexOf(a.id) - order.indexOf(b.id); });
        }
        ...
        sections.forEach(function(section){
            ...
            btn.on("click", function(){
                ...
                Lampa.Listener.send("main_section_change");
            });
        ...
        if(typeof $.fn.sortable === "function") {
            panel.sortable({
                ...
                update: function() {
                    ...
                    Lampa.Listener.send("main_section_reorder");
                }
            });
        }
        ...
        if(!$("head #section-manager-style").length){
            $("head").append(`
                <style id="section-manager-style">
